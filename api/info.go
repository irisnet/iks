...
func (i localInfo) GetType() keyring.KeyType {
...
// GetType implements Info interface
func (i ledgerInfo) GetType() keyring.KeyType {
	return keyring.TypeLedger
}
...
// GetType implements Info interface
func (i offlineInfo) GetType() keyring.KeyType {
	return keyring.TypeOffline
}
...
// GetType implements Info interface
func (i multiInfo) GetType() keyring.KeyType {
	return keyring.TypeMulti
}
...
func unmarshalInfo(bz []byte) (info Info, err error) {
	...
	if ok {
		var multi multiInfo
		err = cdc.UnmarshalBinaryLengthPrefixed(bz, &multi)
